...
But any other [event emitter](http://nodejs.org/api/events.html#events_class_events_eventemitter)
providing `.emit`, `.on,` `.off` will work. If the storage and client run
